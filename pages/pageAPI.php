<p>
    <i><strong>API REST</strong></i>, também chamada de <i><strong>API RESTful</strong></i>, é uma interface de programação de aplicações (API ou API web) que está em conformidade com as restrições do estilo de arquitetura REST, permitindo a interação com serviços web <i>RESTful</i>. <i>REST</i> é a sigla em inglês para <i>"Representational State Transfer"</i>, que em português significa tansferência de estado representacional.
</p>
<p>
